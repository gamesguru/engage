...
complete -c engage -n "__fish_engage_needs_command" -s p -l process -d 'Select a process' -f -a "(engage list 2>/dev/null)"
...
complete -c engage -n "__fish_engage_using_subcommand dot" -s p -l process -d 'Select a process' -f -a "(engage list 2>/dev/null)"
